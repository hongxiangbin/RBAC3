...
public class PermissionController extends BaseController {
	...
	public ModelAndView index(String findContent,ModelMap modelMap,Integer pageNo){
		...
		Pagination<SysResource> permissions = permissionService.findPage(modelMap,pageNo,pageSize);
	...
	@ResponseBody
	public Map<String,Object> addPermission(SysResource psermission){
		try {
			SysResource entity = permissionService.insertSelective(psermission);
